...
class RGCNLinkDataset(object):
    ...
    def load(self, load_time=True):
        ...
        self.num_nodes = len(entity_dict) # 正常个数
        print("# Sanity Check:  entities: {}".format(self.num_nodes)) # 完整性检查
        self.num_rels = len(relation_dict) # 正常个数
...
def _read_triplets_as_list(filename, entity_dict, relation_dict, load_time):
    ...
    for triplet in _read_triplets(filename):
        ...
        if load_time:
            ...
            l.append([s, r, o, st]) # 每一条事实的[s, r, o, time] [[s, r, o, time], []...]
        else:
            l.append([s, r, o])
    return l # [[s, r, o, time], []...]
